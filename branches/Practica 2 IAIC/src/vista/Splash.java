/*
 * Clase encargada de mostrar el splash dinamico de la aplicacion
 */

/*
 * Splash.java
 *
 * Created on 04-feb-2009, 3:49:53
 */
...
public class Splash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(vista.Principal.class).getContext().getResourceMap(Splash.class);
    ...
    public class FondoPanel extends javax.swing.JPanel {
     ...
     public FondoPanel() {
        ...
        private FondoPanel(String string) {
            org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(main.AsesorLaboral.class).getContext().getResourceMap(PrincipalView.class);
            imgFondo = resourceMap.getImageIcon("splash1").getImage();
        }
     ...
     void pintarImagen(String imagen){
         ...
         imgFondo = resourceMap.getImageIcon("splash2").getImage();
         /*repaint();
